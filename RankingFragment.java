...
import com.example.ishitajain.myapplication.Interface.RankingCallBack;
...
import com.example.ishitajain.myapplication.Model.Ranking;
import com.example.ishitajain.myapplication.ViewHolder.RankingViewHolder;
...
public class RankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Becoz OrderByChild method of firebase will sort list in ascending order
        ...
        updateScore(Common.currentUser.getUserName(), new RankingCallBack<Ranking>() {
            ...
            public void callBack(Ranking ranking) {
                ...
                rankingTbl.child(ranking.getUserName())
                        .setValue(ranking);
                //showRanking();//After upload we will sort ranking table and show results
        ...
        questionScore.orderByChild("user").equalTo(userName)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        //After summary scores,we need process sum variable here
                        //Because firebase is asyn,so if process outside,,our sum will be reset to 0
